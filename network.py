...
class GALPRUN():
    def __init__(self,batchSize,vgg_path=""):    
        ...
        self.init_linear_distance_rate()
        self.change_mask()
        mo=self.make_model(is_mask=False)
        print(mo)
        # for jj,hh in mo.named_parameters():
        #     print(jj,hh.data.size())
    ...
    def make_model(self,is_mask=True):
        ...
        model_out=vgg.VGG(features,num_classes=10, init_weights=False,cl_n1=model_list_f[-2],cl_n2=model_list_c[0],cl_n3=model_list_c[1])
        ii=0
